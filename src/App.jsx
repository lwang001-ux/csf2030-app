...
// Skills data with grade-level lesson prompts
const SKILLS = [
  // Core Skills (2030) - Top Right Quadrant - matching WEF original positions
  { id: "ai", name: "AI & Big Data", category: "technology", x: 55, y: 88, quadrant: "core",
  ...
  { id: "techlit", name: "Tech Literacy", category: "technology", x: 55, y: 73, quadrant: "core",
  ...
  { id: "resilience", name: "Resilience & Agility", category: "selfEfficacy", x: 72, y: 68, quadrant: "core",
  ...
  { id: "curiosity", name: "Curiosity & Learning", category: "engagement", x: 48, y: 68, quadrant: "core",
  ...
  { id: "creative", name: "Creative Thinking", category: "cognitive", x: 58, y: 63, quadrant: "core",
  ...
  { id: "talent", name: "Talent Mgmt", category: "management", x: 52, y: 62, quadrant: "core",
  ...
  { id: "leadership", name: "Leadership", category: "management", x: 58, y: 57, quadrant: "core",
  ...
  { id: "analytical", name: "Analytical Thinking", category: "cognitive", x: 68, y: 58, quadrant: "core",
  ...
  { id: "motivation", name: "Motivation", category: "selfEfficacy", x: 60, y: 52, quadrant: "core",
  ...
  { id: "empathy", name: "Empathy & Listening", category: "workingWithOthers", x: 55, y: 46, quadrant: "core",
  ...
  { id: "wellness", name: "Physical Wellness", category: "physical", x: 68, y: 48, quadrant: "core",
    primary: "Daily movement; healthy habits; rest and play balance",
    middle: "Fitness goals; nutrition awareness; sleep hygiene",
    high: "Holistic health planning; stress management; wellness advocacy" },

  // Emerging Skills - Top Left Quadrant
  { id: "cyber", name: "Cybersecurity", category: "technology", x: 25, y: 73, quadrant: "emerging",
  ...
  { id: "environment", name: "Environmental Care", category: "ethics", x: 22, y: 58, quadrant: "emerging",
  ...
  { id: "design", name: "Design & UX", category: "technology", x: 25, y: 50, quadrant: "emerging",
  ...
  { id: "teamwork", name: "Teamwork", category: "workingWithOthers", x: 28, y: 62, quadrant: "emerging",
    primary: "Group games; shared responsibilities; taking turns leading",
    middle: "Team roles and norms; conflict resolution; group accountability",
    high: "High-performing teams; distributed leadership; virtual collaboration" },
  { id: "problemsolving", name: "Problem Solving", category: "cognitive", x: 32, y: 55, quadrant: "emerging",
    primary: "Puzzles and brain teasers; trial and error exploration; 'what could we try?' discussions",
    middle: "Design thinking challenges; root cause analysis; structured problem-solving methods",
    high: "Complex problem decomposition; algorithmic thinking; innovative solution development" },
  { id: "selfreg", name: "Self-Regulation", category: "selfEfficacy", x: 38, y: 68, quadrant: "emerging",
    primary: "Calm-down corners; breathing exercises; emotion naming",
    middle: "Goal monitoring; impulse control strategies; stress management",
    high: "Executive function training; metacognition; emotional intelligence" },
  { id: "influence", name: "Influence & Networking", category: "engagement", x: 22, y: 65, quadrant: "emerging",
    primary: "Making friends; sharing ideas; show and tell presentations",
    middle: "Building connections; collaborative networks; peer influence",
    high: "Professional networking; stakeholder engagement; coalition building" },
  { id: "projectmgmt", name: "Project Management", category: "management", x: 30, y: 72, quadrant: "emerging",
    primary: "Planning simple projects; task sequencing; tracking progress with stickers",
    middle: "Gantt charts basics; milestone planning; team coordination",
    high: "Agile methodologies; risk management; complex project delivery" },
  { id: "integrity", name: "Integrity", category: "ethics", x: 42, y: 62, quadrant: "emerging",
  ...
  { id: "attention", name: "Attention to Detail", category: "cognitive", x: 62, y: 35, quadrant: "steady",
    primary: "Spot the difference games; careful coloring; following multi-step directions",
    middle: "Proofreading and editing; lab observations; quality checks on work",
    high: "Technical review; precision analysis; error detection and correction" },
  { id: "digitaltools", name: "Digital Tools", category: "technology", x: 68, y: 40, quadrant: "steady",
    primary: "Basic apps for learning; drawing on tablets; educational games",
    middle: "Productivity software; collaboration tools; digital organization",
    high: "Advanced software proficiency; automation tools; digital workflows" },
  { id: "publicspeaking", name: "Public Speaking", category: "engagement", x: 58, y: 32, quadrant: "steady",
    primary: "Circle time sharing; show and tell; speaking in front of class",
    middle: "Presentations with visuals; debate basics; storytelling techniques",
    high: "Persuasive speaking; conference presentations; media communication" },
  { id: "responsibility", name: "Responsibility", category: "ethics", x: 48, y: 38, quadrant: "steady",
    primary: "Classroom jobs; taking care of belongings; owning mistakes",
    middle: "Personal accountability; community responsibilities; consequence understanding",
    high: "Civic responsibility; professional accountability; ethical decision-making" },
  { id: "endurance", name: "Endurance & Stamina", category: "physical", x: 72, y: 28, quadrant: "steady",
    primary: "Active play; movement breaks; building sitting stamina",
    middle: "Physical challenges; sustained focus activities; energy management",
    high: "Long-term project stamina; physical fitness; work-life balance" },
  { id: "service", name: "Service Orientation", category: "workingWithOthers", x: 55, y: 42, quadrant: "steady",
  ...
  { id: "resource", name: "Resource Mgmt", category: "management", x: 55, y: 28, quadrant: "steady",
  ...
  { id: "dependable", name: "Dependability", category: "selfEfficacy", x: 45, y: 22, quadrant: "steady",
  ...
  { id: "programming", name: "Programming", category: "technology", x: 18, y: 38, quadrant: "foundational",
  ...
  { id: "marketing", name: "Marketing", category: "engagement", x: 28, y: 42, quadrant: "foundational",
  ...
  { id: "global", name: "Global Citizenship", category: "ethics", x: 18, y: 32, quadrant: "foundational",
  ...
  { id: "teaching", name: "Teaching", category: "engagement", x: 32, y: 36, quadrant: "foundational",
  ...
  { id: "multilingual", name: "Multi-lingual", category: "cognitive", x: 25, y: 30, quadrant: "foundational",
  ...
  { id: "quality", name: "Quality Control", category: "management", x: 38, y: 30, quadrant: "foundational",
  ...
  { id: "persistence", name: "Persistence", category: "selfEfficacy", x: 42, y: 28, quadrant: "foundational",
    primary: "Try again encouragement; puzzle completion; not giving up stories",
    middle: "Long-term projects; overcoming obstacles; grit development",
    high: "Sustained effort on complex goals; failure recovery; tenacity" },
  { id: "collaboration", name: "Collaboration", category: "workingWithOthers", x: 35, y: 22, quadrant: "foundational",
    primary: "Partner work; sharing materials; group projects with defined roles",
    middle: "Team-based learning; peer feedback protocols; collaborative problem-solving",
    high: "Cross-functional teams; consensus building; collaborative leadership" },
]
...
const CATEGORY_CONNECTIONS = {
  cognitive: "These cognitive skills form a thinking toolkit. Analytical thinking provides the logic, creative thinking generates possibilities, and systems thinking connects ideas across domains. Teaching them together creates versatile problem-solvers.",
  technology: "Technology skills build on each other: programming provides the foundation, technological literacy ensures wise usage, AI/big data skills prepare for the future, and cybersecurity protects what's built. Integrated teaching creates responsible digital citizens.",
  selfEfficacy: "Self-efficacy skills reinforce each other. Resilience helps recover from setbacks, motivation drives action, and dependability ensures follow-through. Together they create students who believe in their ability to succeed.",
  engagement: "Engagement skills fuel learning. Curiosity sparks interest, emotional intelligence sustains effort through challenges. Teaching them together creates intrinsically motivated learners.",
  management: "Management skills prepare future leaders. Talent management develops team awareness, leadership provides direction, and resource management ensures efficiency. Combined, they develop organizational capability.",
  workingWithOthers: "Collaboration skills are interdependent. Empathy enables understanding others, service orientation creates purpose, and teamwork puts it all into practice. Together they build community-minded individuals.",
  ...
  physical: "Physical skills connect mind and body. Sensory processing builds awareness, manual dexterity enables creation. Teaching both develops embodied learners who can translate ideas into tangible outcomes."
}
